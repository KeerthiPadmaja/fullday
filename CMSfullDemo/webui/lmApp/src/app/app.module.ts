...
import { CusttcComponent } from './custtc/custtc.component';
import { VendtcComponent } from './vendtc/vendtc.component';
...
[
  {path:'placeOrder', component:PlaceOrderComponent, outlet:'data'},
    ...
    {path:'customertc', component:CusttcComponent, outlet:'data'},
  ]
 },
 ...
 [
   ...
   {path:'vendortc', component:VendtcComponent, outlet:'data'},
 ]
},
