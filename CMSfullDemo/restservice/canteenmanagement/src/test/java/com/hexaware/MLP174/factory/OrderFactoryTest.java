...
/**
  ...
  */
  ...
  @Test
  public final void testpayGst(@Mocked final OrderDAO dao) throws ParseException {
    // GstDemo gstDemo = new GstDemo(2,2.50,2.50,2);
    final GstDemo order1 = new GstDemo();
    order1.setVenId(1);
    order1.setCgst(2.50);
    order1.setSgst(2.50);
    order1.setMonthNo(3);
   ...
   String result1 = OrderFactory.payGst(order1);
   assertEquals(result1, "Gst Stored...");
  }
  // @Test
  // public final void testshowgstbyMonth(@Mocked final OrderDAO dao) throws ParseException {
  //   // GstDemo gstDemo = new GstDemo(2,2.50,2.50,2);
  //   final GstDemo order = new GstDemo();
  //   order.setVenId(1);
  //   order.setCgst(2.50);
  //    order.setSgst(2.50);
  //    order.setMonth(3);
  ...
  //     }
  //   };
  //  Double result1 = OrderFactory.showgstbyMonth(order.getVenId());
